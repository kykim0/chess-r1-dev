...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-"legal-rules_l${MAX_LEN}_t${TEMPERATURE}"}
...
resume_path="/home/kykim/dev/repos/cr1/outputs/chess-r1/0119-1257_legal-rules_l1024_verl_Qwen3-4B"
trainer_args=" \
