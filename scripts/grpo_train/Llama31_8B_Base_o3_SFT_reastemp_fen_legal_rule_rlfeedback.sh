...
export BASE_MODEL=${BASE_MODEL:-"godnpeter/llama_chess_o3_981samples_epoch10"}

# Experiment metadata
export USER_NAME=${USER_NAME:-"USER"}
export GROUP_NAME=${GROUP_NAME:-"Llama31_8B_Base"}
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-"o3_sft_yesreastemp_fen_legal_rule_yesRLfeedback"}
