...
export DATA_DIR=${DATA_DIR:-"data/lichess_200k_qwen_instruct_reasoningtemplate_san_fen_legal_rule"}
export BASE_MODEL=${BASE_MODEL:-"Qwen/Qwen2.5-7B-Instruct"}

# Experiment metadata
export USER_NAME=${USER_NAME:-"hj"}
export GROUP_NAME=${GROUP_NAME:-"dapo_FFT"}
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-"Instruct_reastemplate"}
