...
export DATA_DIR=${DATA_DIR:-"data/chess_best_move_train"}
export BASE_MODEL=${BASE_MODEL:-"joonleesky/qwen_chess2_e3"}

# Experiment metadata
export USER_NAME=${USER_NAME:-"evaluation"}
export GROUP_NAME=${GROUP_NAME:-"chess_sft"}
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-"chessqwen2_e3_chess_best_move_test_temp7e-1_rollnum1"}
