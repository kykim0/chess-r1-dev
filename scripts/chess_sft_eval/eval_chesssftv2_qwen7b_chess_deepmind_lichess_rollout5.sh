...
export DATA_DIR=${DATA_DIR:-"data/deepmind_lichess_test_qwen_instruct_reasoningtemplate_san_fen_legal_rule_table"}
export BASE_MODEL=${BASE_MODEL:-"joonleesky/qwen_chess1_2of5"}

# Experiment metadata
export USER_NAME=${USER_NAME:-"evaluation"}
export GROUP_NAME=${GROUP_NAME:-"chess_sft"}
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-"chessqwen1_2of5_chess_deepmind_lichess_test_temp7e-1_rollnum5"}
