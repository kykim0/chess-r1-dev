...
export DATA_DIR=${DATA_DIR:-"data/chess_modeling_instruct_test"}
...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-"chessqwen1_2of5_chess_modeling_instruct_test_temp7e-1_rollnum1"}
