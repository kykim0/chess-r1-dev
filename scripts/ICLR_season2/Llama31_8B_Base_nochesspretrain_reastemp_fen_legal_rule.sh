...
export DATA_DIR=${DATA_DIR:-"data/lichess_db_puzzle_processed_base_fen_legal_rule"}
...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-"llama31_8B_base_yesreastemp_fen_legal_rule_promptfix"}
...
algorithm_args=" \
    ...
    algorithm.max_num_gen_batches=100 \
