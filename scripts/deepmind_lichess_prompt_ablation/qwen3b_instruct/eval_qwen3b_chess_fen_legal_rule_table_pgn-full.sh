...
export DATA_DIR=${DATA_DIR:-"data/deepmind_lichess_test_qwen_instruct_fen_legal_rule_table_pgn-full"}
export BASE_MODEL=${BASE_MODEL:-"Qwen/Qwen2.5-3B-Instruct"}

# Experiment metadata
export USER_NAME=${USER_NAME:-"evaluation"}
export GROUP_NAME=${GROUP_NAME:-"lichess_prompt_ablation"}
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-"qwen3b_instruct_deepmind_lichess_qwen_instruct_fen_legal_rule_table_pgn-full"}
