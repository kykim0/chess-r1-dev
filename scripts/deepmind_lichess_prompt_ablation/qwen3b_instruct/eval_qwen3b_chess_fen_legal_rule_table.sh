...
export DATA_DIR=${DATA_DIR:-"data/deepmind_lichess_test_qwen_instruct_fen_legal_rule_table"}
...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-"qwen3b_instruct_deepmind_lichess_qwen_instruct_fen_legal_rule_table"}
