...
export DATA_DIR="data/dev_chess_deepseekr1distill_instruct_with_legal_move_200000_1000"
export BASE_MODEL="deepseek-ai/DeepSeek-R1-Distill-Qwen-7B"

# Experiment metadata
export USER_NAME="DY"
export GROUP_NAME="qwen7B_r1distill"
export EXPERIMENT_NAME="bs128n4_r1distill_default"
