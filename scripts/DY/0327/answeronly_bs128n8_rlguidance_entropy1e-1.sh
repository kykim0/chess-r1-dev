...
export DATA_DIR="data/dev_chess_qwen_instruct_with_legal_move_answer_only_200000_1000"
export BASE_MODEL="Qwen/Qwen2.5-7B-Instruct"

# Experiment metadata
export USER_NAME="DY"
export GROUP_NAME="answer_only_overfit_smalldata"
export EXPERIMENT_NAME="bs128n8_qvalues_scale10_entropy1e-1"
...
reward_args=" \
    reward_model.use_lg_consistency_rew=False \
    reward_model.use_stockfish=False \
    reward_model.use_chess_model_best=False \
    reward_model.use_chess_model_qvalue=True \
    reward_model.answer_scale=10.0 \
"
...
TRAIN_ARGS="$trainer_args $data_args $actor_args $rollout_args $reference_args $reward_args $algorithm_args"
