...
# export DATA_DIR="data/dev_chess_base_with_legal_move"
export DATA_DIR="data/dev_chess_llama_instruct_with_legal_move"

# Experiment metadata
export USER_NAME="DY"
export GROUP_NAME="chess_init_eval"
export EXPERIMENT_NAME="test_llama_instruct_faster"
...
python -m verl.trainer.eval_grpo $ARGS \
