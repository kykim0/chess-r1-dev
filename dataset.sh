...
# mv chess_annotation_train.jsonl ../verl/third_party/SkyThought/skythought/train/LLaMA-Factory/data2
# mv chess_best_move_train.jsonl ../verl/third_party/SkyThought/skythought/train/LLaMA-Factory/data2
# mv chess_comparison_train.jsonl ../verl/third_party/SkyThought/skythought/train/LLaMA-Factory/data2
# mv chess_mechanics_train.json ../verl/third_party/SkyThought/skythought/train/LLaMA-Factory/data2
