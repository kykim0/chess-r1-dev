...
if __name__ == '__main__':
    ...
    parser.add_argument("--delete_after_merge", action="store_true", help="Delete .pt files after merging")
   ...
   # Delete .pt files if --delete_after_merge is enabled
    if args.delete_after_merge:
        print("Deleting .pt files after merge...")
        for filename in os.listdir(local_dir):
