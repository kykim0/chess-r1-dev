...
def validate_chess_move_data_gt(
    fen: str, 
    move: str, 
    optimal_move: str, 
    logs: dict,
    ...
    """
    Validates a chess move by comparing it against a provided optimal move from the data.
    """
    board, legal_moves, logs = _validate_move_format_and_legality(fen, move, logs)
    if board is None:
...
def compute_score(solution_str: str, 
                 ...
                 use_data_gt: bool,
                 use_chess_model_best: bool,
                 use_chess_model_qvalue: bool,
                 use_lg_consistency_rew: bool,
    ...
    english_score = 0
    if answer_text and use_lg_consistency_rew:
    ...
    try:
        if format_correct and answer_text:
            if use_data_gt:
                answer_score, logs = validate_chess_move_data_gt(
                                        fen=fen_state,
                                        move=answer_text,
